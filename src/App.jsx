        ...
        <Routes>
          ...
          <Route path="/" element={
            <div>
              ...
              <section>
                <h2>Mejora tus Habilidades Fotográficas</h2>
                <p> <b>Guías prácticas:</b>
                <ul>
                  <li>Cómo aprovechar la luz natural</li>
                  <li>Composición básica</li>
                  <li>Colores</li>
                </ul>
                </p> <br/>
                <center> <p>Descubre el arte de contar historias a través de la cámara. Únete a nuestras clases para mejorar tus habilidades y capturar momentos únicos.</p> </center>
              </section>

              <section>
                <h2>Crea Algo Increíble Juntos</h2>
                <p> <b>Fotografía personalizada:</b> Retratos, bodas, eventos o productos. </p> <br/>
                <p>Trabajemos juntos para transformar ideas en imágenes impactantes.</p> <br/><br/>
                <center> <b>Contáctame para discutir tu próximo proyecto creativo.</b> </center> 
              </section>
